        ...
        <div class="card ">
            ...
            <?php if ($a == "expired") { ?>
              ...
              <div class="col-lg-12">
                ...
                <?php if ($_SESSION['wrong'] == "YES") { ?>
                  <div class="row">
              <div class="col-lg-12">
                  <div class="card">
                      <div class="card-body">
                    <h2 class="card-title">Password Doesnot Match</h2>
                          <div class="alert alert-warning" role="alert">
                            <strong>Please Try Again!. Thank You</strong>!.
                          </div>
            ...
            <div class="card-body">
                <form method="POST" action="pages/action_password_reset">
