...
$activity = "Program Or Event Delete";
$summary = "Program Or Event Delete Activity Recorded From Device And IP"; 
...
$deleted= "YES";
  ...
  $stmtp = $pdo->prepare("UPDATE events_calendar SET deleted = :deleted  WHERE u_id = :u_id AND event_id = :id");
