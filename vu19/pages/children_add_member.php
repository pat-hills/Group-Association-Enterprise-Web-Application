                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Member's Child Or Children </h2>
        ...
        <button type="button" class="close" data-dismiss="alert">&times;</button>
          <strong><i class="icon-user icon-large"></i>&nbsp;Action Completed Sucessfully;    <a style = "color :green;" class="nav-link" href="./pages/r?inv17ml44=appraisal_list">Click To Member List</a></strong>  <br/>
                ...
                <div class="row">
                       ...
                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                           <div class="card">
                               <h5 class="card-header">Number Of Children Form</h5>
                               <div class="card-body">
...
if(isset($_POST['submitt'])){
    $secretary->insert_children();
}                                   
                                     
                                     ?>

<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Enter # Of Children</label>
                                            <div class="col-12 col-sm-9 col-lg-6">
                                                <table>
                                                    <tr>
                                                        <td><input required style="width:150px;" autocomplete="off" type="text" name="entries"  placeholder="No. Of Children" class="form-control"></td>
                                    ...
                                    for ($j = 1; $j <= $entries; $j++) {
                                        ?>
                                                <table>
                                                    ...
                                                    <tr>
                                                    <td><label class="col-12 col-sm-3 col-form-label text-sm-right">Fullname</label></td>
                                                        <td><input required style="width:150px;" type="text" name="fullname[]"  placeholder="Enter Fullname" class="form-control"></td>
                                                        <td><label class="col-12 col-sm-3 col-form-label text-sm-right">Select Gender</label></td>  
                                                        <!-- <td><input required style="width:150px;" type="text" name="sex[]"  placeholder="Enter Sex" class="form-control"></td>
                                                         -->
                                                        <td>
                                    ...
                                    if(isset($_POST["submit_entries"])) {
                                        ?>
                                           ...
                                           <div class="col-sm-6 pl-0">
                                               <p class="text-left">
                                                   <button name="submitt" class="btn btn-space btn-primary">Add Record</button>
