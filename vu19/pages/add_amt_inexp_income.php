                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <!-- <a style="float :right; margin-left:15px;" target="_blank" href="pages/pr_mem" class="btn btn-primary">
                                    ...
                                    <a style="float :right;" href="pages/add_amt_inexp_income_pr" target="_blank" class="btn btn-primary">
                                            Print List
                                        </a>
                                <h5 class="mb-0">List Of Income Entries</h5>
                           
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="allincomeonly" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Amount (GHS)</th>
