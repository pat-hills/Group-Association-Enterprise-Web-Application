 ...
 <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="pages/add_houses_action_edit" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                value="<?php
                                             $last_ =  $secretary -> get_houses_detail_by_id();
                                             echo $last_['id'];
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required name="housename"  placeholder="First Name"
                                                
                                                value="<?php
                                             $last_name =  $secretary -> get_houses_detail_by_id();
                                             echo $last_name['house_name'];
                                        ...
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                ...
                                                <a href="./pages/r?inv17ml44=add_houses" class="btn btn-space btn-secondary">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
