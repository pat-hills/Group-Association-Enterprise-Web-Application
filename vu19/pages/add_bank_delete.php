                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Delete Information</h2>
 ...
 <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <form method="post" action="pages/add_bank_delete_action" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                value="<?php
                                             $last_ =  $accountant -> get_details_of_bank_id();
                                             echo $last_['id'];
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" readonly required name="bank_name"  placeholder="First Name"
                                                
                                                value="<?php
                                             $bank_name =  $accountant -> get_details_of_bank_id();
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" readonly required name="acc_number"  placeholder="First Name"
                                                
                                                value="<?php
                                             $acc_number =  $accountant -> get_details_of_bank_id();
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" readonly required name="branch"  placeholder="First Name"
                                                
                                                value="<?php
                                             $branch =  $accountant -> get_details_of_bank_id();
                                             echo $branch['branch'];
                                        ...
                                        <div class="form-group row text-right">
                                            ...
                                            <button type="submit" onclick="return(confirm('Are you sure you want to delete? Click OK to finish action or Cancel'))" class="btn btn-space btn-primary">DELETE</button>
                                                ...
                                                <a href="./pages/r?inv17ml44=add_bank_details" class="btn btn-space btn-secondary">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
