...
$activity = "Houses Delete";
$summary = "House Delete Activity Recorded From Device And IP"; 
...
$deleted = "YES";
  ...
  $stmtp = $pdo->prepare("UPDATE assoc_houses SET deleted = :house_name WHERE u_id = :u_id AND id = :id");
  
  $stmtp ->bindParam(':house_name', $deleted,PDO::PARAM_STR);
