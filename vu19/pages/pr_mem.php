...
$pageTitle = "<strong>" . htmlentities( " " .  $_SESSION['grp']."  POPULATION AS AT  " . strtoupper(date("F j, Y"))) . "</strong>";
...
<td style="text-align: left; width: 20%;"><strong>Occupation</strong></td>
<td style="text-align: left; width: 15%;"><strong>House name</strong></td>    
<td style="text-align: left; width: 15%;"><strong>Phone number</strong></td>      
...
while ($row = mysqli_fetch_array($allg)) {
   ...
   <td style="width: 20%; text-align: left;">' . htmlentities($row["profession"]) . '</td> 
   <td style="width: 15%; text-align: left;">' . htmlentities($row["house_name"]) . '</td> 
   <td style="width: 15%; text-align: left;">' . htmlentities($row["phone_number"]) . '</td> 
