                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Bill Ledger</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <table>
                                <tr>
                                    <td> <label for="inputWebSite" class="col-4 col-lg-2 col-form-label text-right">Select Category & Billed Item</label></td>
                               
                                    <td> 
                                    <div class="col-4 col-lg-10">
                                           <select style="width:auto;" required name="house_name" class="form-control">
                   <option>---SELECT OPTION---</option>
                   <?php $secretary->houses_or_groups_members_in_bill_item() ?>
                   </select>
                                           </div>
                                    ...
                                    <td>
                                    <div class="col-4 col-lg-10">
                                           <button type="submit" name="save" class="btn btn-primary">Load Members</button>
                                           </div>
                                 </td>
...
if (!isset($billee)) {
    $billee = "";
                       ...
                       if(isset($_POST['save'])){
                        ...
                        //    if(!is_null($ldg_amt)){
                        //     echo '<button style=margin-left :30px;   name=submitt class="btn btn-primary">Apply Bill Ledger </button>';   
                        //    }
...
<div style="" class="form-group row">
                            <table>
                                <tr>
                                    ...
                                    <td> 
                                    <div class="col-4 col-lg-10">
                                    <button type="submit" name="submitt" class="btn btn-warning">Add Bill To Ledger</button>        
                                    </div>
                                    ...
                                    <td>
                                    <div class="col-4 col-lg-10">
                                    <label for="inputWebSite" class="col-4 col-lg-2 col-form-label text-right"></label> 
                                           </div>
                                 </td>
...
<!--                                                 
                                           ...
                                           <div style="float : left" class="col-sm-6 pl-0">
                                               <p class="text-left">
                                                   <button name="submitt" class="btn btn btn-danger">Add To Ledger</button>
