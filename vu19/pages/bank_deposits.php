                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="pages/bank_deposit_action" method="POST">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Depositor</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="decimal" required name="depositor" placeholder="Enter Amount" class="form-control">
                                                                            </div>
                                                                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <!-- <a style="float :right; margin-left:15px;" target="_blank" href="pages/pr_mem" class="btn btn-primary">
                                ...
                                <h5 class="mb-0">List Of Bank Deposits</h5>
