                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Bank Withdrawals</h2>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                                <h5 class="card-header">Withdrawals Form</h5>
                                                                <div class="card-body">
                                                                    <form action="pages/bank_withdrawals_action" method="POST">

                                                                    <div class="form-group row">
                                                                                <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Bank name</label>
                                                                                <div class="col-9 col-lg-10">

                                                                                    <select required class="form-control" name="bankname">
                                                                                     <option>--SELECT--</option>
                                                                                     <?php 
                                                                                     
                                                                                     $accountant -> bankdropdown();
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="decimal" required name="accountAmount" placeholder="Enter Amount" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text" required name="depositor" placeholder="Name Of Person" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <textarea class="form-control" name="reason" placeholder="Enter reason for withdrawal">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <!-- <a style="float :right; margin-left:15px;" target="_blank" href="pages/pr_mem" class="btn btn-primary">
                                ...
                                <h5 class="mb-0">List Of Bank Withdrawals</h5>
