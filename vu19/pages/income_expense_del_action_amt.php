...
$activity = "Income & Expense Amount Delete";
$summary = "Income & Expense Amount Delete Activity Recorded From Device And IP"; 
 ...
 }else
{
  ...
  $stmtp = $pdo->prepare("UPDATE income_exp SET deleted =:deleted  WHERE u_id = :u_id AND id = :id");
