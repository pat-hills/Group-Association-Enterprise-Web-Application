 ...
 <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="pages/income_expense_delete_action" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                value="<?php
                                             $last_ =  $accountant -> get_account_items_detail_by_id();
                                             echo $last_['id'];
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Account Name</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" readonly required name="acc_name"  placeholder="First Name"
                                                
                                                value="<?php
                                             $acc_name =  $accountant -> get_account_items_detail_by_id();
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" readonly required name="account_type"  placeholder="First Name"
                                                
                                                value="<?php
                                             $account_type =  $accountant -> get_account_items_detail_by_id();
                                        ...
                                        <div class="form-group row text-right">
                                            ...
                                            <button type="submit" onclick="return(confirm('Are you sure you want to delete? Click OK to finish action or Cancel'))" class="btn btn-space btn-primary">DELETE</button>
                                                ...
                                                <a href="./pages/r?inv17ml44=add_acc_inexp" class="btn btn-space btn-secondary">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
