...
<div class="dashboard-wrapper">
        ...
        <button type="button" class="close" data-dismiss="alert">&times;</button>
          <strong><i class="icon-user icon-large"></i>&nbsp;Action Completed Failed (Sending Email / SMS Receipt);    <a style = "color :green;" class="nav-link" href="./pages/r?inv17ml44=members_payment_list">Click To Member List</a></strong>  <br/>
                           ...
                           <div class="card">
                               ...
                               <img src="
                                        ...
                                        if($img){
                                            ...
                                            echo $root_url."assets/images/avatar-1.jpg";
                                        }
                               ...
                               <div class="card-body">
                                   <form action="#" id="basicform" data-parsley-validate="">
                                       ...
                                       <div class="form-group">
                                           <label for="inputPassword">Phone number for SMS</label>
                                           <input readonly id="inputPassword" type="text" placeholder="Password" name="sms_format_1" required=""
                                           
                                           value="<?php
                                             $sms_format_1 =  $accountant -> get_member_detail_by_id();
                                             echo $sms_format_1['sms_format_1'];
                       ...
                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                           <div class="card">
                               ...
                               <div class="card-body">
                                   ...
                                   <form method="post" action="pages/payments_ledger_action" class='form-horizontal' role='form'>
                                   ...
                                   <?php 
                                     ?>
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                                   ...
                                                   $allbill_ledger_items = $accountant->get_bill_items_in_ledger_general();
                                    $i = 1;

                                    foreach ($allbill_ledger_items as $data_item) {
                                        ?>
                                                <table>
                                                    <tr>
                                                    <td><label class="col-12 col-sm-3 col-form-label text-sm-right">Gen. Bill</label></td>
                                                        <td><input readonly value="<?php echo $data_item['bill_item'] ?>" required style="width:150px;" type="text" name="bill_item[]"  placeholder="Enter Fullname" class="form-control"></td>
                                                        <td><label class="col-12 col-sm-3 col-form-label text-sm-right">Amount</label></td>  
                                                        <td><input value="0.00" required style="width:150px;" type="text" name="amount[]"  placeholder="Enter Amount" class="form-control"></td>
                                     ...
                                     ?>
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                                   ...
                                                   $allbill_ledger_items = $accountant->get_bill_items_in_ledger_individual();

                                                   if(!$allbill_ledger_items){
                                                       echo "_No Individual Bill Item For Member_";
                                                   }
                                    ...
                                    foreach ($allbill_ledger_items as $data_item) {
                                        ?>
                                                <table>
                                                    <tr>
                                                    <td><label class="col-12 col-sm-3 col-form-label text-sm-right">Ind. Bill</label></td>
                                                        <td><input readonly value="<?php echo $data_item['bill_item'] ?>" required style="width:150px;" type="text" name="bill_item[]"  placeholder="Enter Fullname" class="form-control"></td>
                                                        <td><label class="col-12 col-sm-3 col-form-label text-sm-right">Amount</label></td>  
                                                        <td><input value="0.00" required style="width:150px;" type="text" name="amount[]"  placeholder="Enter Amount" class="form-control"></td>
                                    ...
                                    ?>
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                               <input name="chequenumber" id="inputWebSite" type="number"  placeholder="ENTER CHEQUE NO." class="form-control">
                                           </div>
                                       </div>
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                               <input name="paid_by" id="inputWebSite" type="text" required placeholder="PAID BY" class="form-control">
                                           </div>
                                       </div>
                                       ...
                                       <div class="form-group row">
                                           ...
                                           ?>"
                                               ...
                                               <input name="email_id" value="
                                               <?php
                                                   $email_id =  $accountant -> get_member_detail_by_id();
