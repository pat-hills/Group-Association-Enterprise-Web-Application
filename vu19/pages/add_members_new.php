                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required name="first_name"  placeholder="Enter First Name" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required name="other_name"  placeholder="Enter Other Name" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="place_of_birth" required placeholder="Enter Place Of Birth" class="form-control">
                                            </div>
                                        </div>
                                     ...
                                     <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input name="profession" type="text" required placeholder="Enter Profession" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Email ID</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input name="email_id" type="email" required  placeholder="Enter Email ID" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="phone_number"   required  placeholder="Enter Phone Number" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="secondary_number"   required  placeholder="Enter Phone Number" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-9 col-lg-6">
                                                <table>
                                                    <tr>
                                                        <td><input required style="width:150px;" type="text" name="street_name_house_address"  placeholder="Enter Street No." class="form-control"></td>
                                                        <td><input required style="width:150px;" type="text" name="city_house_address"  placeholder="Enter City" class="form-control"></td>
                                                        <td>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="long_lived_house"  placeholder="Enter How Long Have You Lived There?" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="house_less_than_3"  placeholder="Enter Former Residence If Less Than 3 yrs" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-9 col-lg-6">
                                                <table>
                                                    <tr>
                                                        <td><input required style="width:150px;" type="text" name="postal_address"  placeholder="Enter P.O.Box " class="form-control"></td>
                                                        <td><input required style="width:150px;" type="text" name="city_postal_address"  placeholder="Enter City" class="form-control"></td>
                                                        <td>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="welfare_pin"  placeholder="Enter Welfare #" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input   type="text" name="court_initiation" required="" placeholder="Enter Council/Court Of Initiation" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input  type="text" name="name_of_parish" required="" placeholder="Enter Name Of Parish" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input name="place_of_baptism"  type="text" required="" placeholder="Enter Place Of Baptism" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row rowtypeoffathersname">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input  type="text" name="fathers_name"   placeholder="Enter Father's Name" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row rowtypeoffatherscontact">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input  type="text" name="fathers_contact"   placeholder="Enter Father's Contact" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row rowtypeoffathersaddress">
                                            ...
                                            <table>
                                                    <tr>
                                                        <td><input  style="width:150px;" type="text" name="fathers_address"  placeholder="Enter Street No." class="form-control"></td>
                                                        <td><input  style="width:150px;" type="text" name="fathers_city_address"  placeholder="Enter City" class="form-control"></td>
                                                        <td>
                                        ...
                                        <div style="display: none;" class="form-group row rowtypeofmothersname">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input  type="text"  name="mothers_name"   placeholder="Enter Mother's Name" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row rowtypeofmotherscontact">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input  type="text"  name="mothers_contact"   placeholder="Enter Mother's Contact" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row rowtypeofmothersaddress">
                                            ...
                                            <table>
                                                    <tr>
                                                        <td><input  style="width:150px;" type="text" name="mothers_address"  placeholder="Enter Street No." class="form-control"></td>
                                                        <td><input  style="width:150px;" type="text" name="mothers_city_address"  placeholder="Enter City" class="form-control"></td>
                                                        <td>
                                        ...
                                        <div style="display: none;" class="form-group row nameofspouse">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input  type="text"   name="name_of_spouse" placeholder="Enter Name of Spouse" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row contactofspouse">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input name="spouse_number"  type="text"  placeholder="Enter Spouse's Phone number" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;" class="form-group row addressspouse">
                                            ...
                                            <table>
                                                    <tr>
                                                        <td><input  style="width:150px;" type="text" name="spouse_address"  placeholder="Enter Street No." class="form-control"></td>
                                                        <td><input  style="width:150px;" type="text" name="spouse_city_address"  placeholder="Enter City" class="form-control"></td>
                                                        <td>
