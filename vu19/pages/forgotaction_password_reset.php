...
$resetPassLink = 'https://app.knustmarshallan.org/vu19/reset-password?token=';
 ...
 }else
{
   ...
   // $pass = filter_input(INPUT_POST, 'pass', FILTER_DEFAULT);
     ...
     $the_no_string = "NO";
           // $pdo = $this->pdo;
            $stmt = $pdo->prepare('SELECT email,u_id,user_type  FROM tbl_sub_user WHERE email = :email AND deleted = :n_o');
