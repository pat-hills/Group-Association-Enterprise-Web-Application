...
$activity = "Billed Amount Edit";
$summary = "Billed Amount Edit Activity Recorded From Device And IP"; 
 ...
 }else
{
  ...
  $stmtp = $pdo->prepare("UPDATE member_bill SET amount_involved = :name_of_program  WHERE u_id = :u_id AND id = :id");
 
  $stmtp ->bindParam(':name_of_program', $amountonbill,PDO::PARAM_STR);
