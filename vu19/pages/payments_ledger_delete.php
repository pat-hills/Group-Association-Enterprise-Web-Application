                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Delete Payments</h2>
                       ...
                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                           <div class="card">
                               ...
                               <div class="card-body">
                                   ...
                                   <form method="post" action="pages/payments_ledger_delete_action" class='form-horizontal' role='form'>
                                   <?php 
...
<div class="form-group row">
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                               <input readonly name="amountpadi" id="inputEmail2" type="decimal"
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                              <select disable class="form-control" name="mop">
                                                  <option>
                                                  <?php 
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                               <input readonly name="chequenumber"
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                               <input readonly name="paid_by" id="inputWebSite"
