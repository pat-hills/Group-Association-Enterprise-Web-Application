	                                ...
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                            ...
                                            if(!$secretary->count_all_events()){
                                                echo '<a class="nav-link" href="./pages/r?inv17ml44=add_event">Add Event</a>';
                                            }else{
	                                ...
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                            ...
                                            if(!$secretary->total_roll_call()){
                                                echo '<a class="nav-link" href="./pages/r?inv17ml44=add_event_role_call">Take Role Call</a>';
                                            }else{
