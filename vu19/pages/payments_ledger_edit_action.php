...
$activity = "Member Payment Edit";
$summary = "Member Payment Edit Activity Recorded From Device And IP"; 
 ...
 }else
{
  ...
  $code = $m."00".$d.$accountant->gen_verification_code().$member_id.$m;
   ...
   $stmt = $pdo->prepare("UPDATE fee_payments SET amount = :amount,mode_of_payment =:mode_of_payment,mode_of_payment_number =:mode_of_payment_number,paid_by =:paid_by WHERE u_id = :u_id AND id =:id");
