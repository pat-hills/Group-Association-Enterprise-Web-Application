...
$activity = "Bank Deposit Registration";
$summary = "Bank Deposit Amount Registration Activity Recorded From Device And IP"; 
...
$stmt = $pdo ->prepare('INSERT INTO bank_deposits(u_id,bank_name,amount_deposited,depositor,date_time,month_deposit,year_deposit,created_by) VALUES
 (:u_id,:bank_name,:amount_deposited,:depositor,:date_time,:month_deposit,:year_deposit,:created_by)');
