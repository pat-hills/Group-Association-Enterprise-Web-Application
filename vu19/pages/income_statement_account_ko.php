...
<div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            <img width=60px height=auto; src="./../images/income_statemet.png"/>
                           <b style="color:#71748d; margin-left:7px;">INCOME STATEMENT</b> 
              ...
              <div class="col-lg-12">
               ...
               <a href="pages/income_statement_account_pr" target="_blank"  class="btn btn-primary">Print Statement</a>
             <?php } ?> 
                            </td>
                            </tr>
                            </table>
                          ...
                          <b> Added Incomes </b> 
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                            <th>Total</th>
                                                <th><?php echo $accountant->sumsearchIncomes();  ?></th>
                          ...
                          <b>  Member Payments </b>
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                            <th>Total</th>
                                                <th><?php echo $accountant->sumsearchpayements();  ?></th>
                                                <th>Date Time</th> 
                                            </tr>
                                        </tfoot>
                                         </table>
                        ...
                        <b>Expenditure</b>
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                            <th>Total</th>
                                                <th><?php echo $accountant->sumsearchExpense();  ?></th>
                                ...
                                <div class="table-responsive"> 
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                            <th>Profit / Loss </th>
                                                <th><?php echo $accountant->profit_loss();  ?></th>
