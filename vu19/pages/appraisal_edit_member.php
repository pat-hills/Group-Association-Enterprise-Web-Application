                       ...
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                           <div class="card">
                               ...
                               <div class="card-body">
                                   ...
                                   <form method="post" action="pages/appraisal_edit_member_acttion" class='form-horizontal' role='form'>
                                   <?php 
                                    ...
                                    // }
                                     ?>
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-9 col-lg-10">
                                               <textarea name="appraisal" id="inputEmail2" type="text" required  placeholder="Appraisal" class="form-control">
                                       ...
                                       <div class="row pt-2 pt-sm-5 mt-1">
                                           ...
                                           <div class="col-sm-6 pl-0">
                                               <p class="text-right">
                                                   <button onclick="return(confirm('Are you sure you want to edit? Click OK to finish action or Cancel'))"  name="submitt" class="btn btn-space btn-primary">EDIT</button>
