                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="page-header">
                            ...
                            <img width=60px height=auto; src="./../images/payment-method.png"/>
                           <b style="color:#71748d; margin-left:7px;">MEMBERS PAYMENT</b> 
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <a style="float :right; margin-left:15px;" target="_blank" href="pages/members_payment_print" class="btn btn-primary">
                                        PRINT DEBTORS AND CREDITORS
                                        </a>
                                    
                                  
                                <h5 class="mb-0">
                                <!-- <img width=20px height=auto; src="./../images/group.png"/>
                                    Members List For Payments On Debtor Or Creditors</h5> -->
                           
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="memberpaymentslist" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Fullname</th>
