                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            <img width=60px height=auto; src="./../images/budget.png"/>
                           <b style="color:#71748d; margin-left:7px;">BILL PREPARATION</b> 
                            </h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="addbillprepartion" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Bill name</th>
                                                <th>House</th>
                                      ...
                                      $accountant->allbillpreparations(); 
