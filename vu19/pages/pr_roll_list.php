...
$pageTitle = "<strong>" . htmlentities( "LIST OF ROLL CALL AS AT  " . strtoupper(date("F j, Y"))) . "</strong>";
...
<tbody>
      <tr style="background-color: #666; color: #fff;">
       ...
       <td style="text-align: left; width: 15%;"><strong>Program name</strong></td>
       
<td style="text-align: left; width: 20%;"><strong>Venue</strong></td>     
<td style="text-align: left; width: 50%;"><strong>Comments</strong></td>   
<td style="text-align: left; width: 10%;"><strong>Date</strong></td>  
</tr>
</tbody>';
...
////Venue / Name / Date / Comment
    $events_calendar_details = events_calendar_details($row['name_of_program']);
 $venue = $events_calendar_details['venue'];
 ...
 $comments = $row['comments']; 
    ...
    <tbody>
        <tr>
            ...
            <td style="width: 15%; text-align: left;">' . htmlentities($name_of_program) . '</td>
 
   <td style="width: 20%; text-align: left;">' . htmlentities($venue) . '</td> 
   <td style="width: 50%; text-align: left;">' . htmlentities($comments) . '</td>
   <td style="width: 10%; text-align: left;">' . htmlentities($date_created) . '</td>
