                     ...
                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                           <div class="card">
                               ...
                               <div class="card-body">
                                   ...
                                   <form method="post" action="pages/change_password_finance_action" class='form-horizontal' role='form'>
                                   <div class="form-group row">
                                           <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-left">New Password</label>
                                           <div class="col-9 col-lg-10">
                                               <input autocomplete="off" name="newpassword" id="inputWebSite" type="password"  placeholder="New Password" class="form-control">
                                           </div>
                                       </div>
