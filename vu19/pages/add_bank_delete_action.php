...
$activity = "Bank Details Delete";
$summary = "Bank Details Delete Activity Recorded From Device And IP"; 
 ...
 }else
{
  ...
  $stmtp = $pdo->prepare("UPDATE bank_details SET deleted = :deleted  WHERE u_id = :u_id AND id = :id");
